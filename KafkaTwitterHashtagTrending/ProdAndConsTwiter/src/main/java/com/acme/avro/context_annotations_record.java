...
public class context_annotations_record extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   * @return A new context_annotations_record RecordBuilder
   */
  public static Builder newBuilder(context_annotations_record other) {
    return new Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<context_annotations_record>
     ...
     * @param other The existing instance to copy.
     */
    private Builder(context_annotations_record other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.domain)) {
        this.domain = data().deepCopy(fields()[0].schema(), other.domain);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setDomain(com.acme.avro.domain value) {
     ...
     * @return This builder.
     */
    public Builder setDomainBuilder(com.acme.avro.domain.Builder value) {
      clearDomain();
      domainBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setEntity(com.acme.avro.entity value) {
     ...
     * @return This builder.
     */
    public Builder setEntityBuilder(com.acme.avro.entity.Builder value) {
      clearEntity();
      entityBuilder = value;
      return this;
    }
