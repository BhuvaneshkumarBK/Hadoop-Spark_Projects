...
public class mentions_record extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public mentions_record(Integer start, Integer end, CharSequence username, CharSequence id) {
    this.start = start;
    this.end = end;
  ...
  public void put(int field$, Object value$) {
    ...
    case 3: id = (CharSequence)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   * @return A new mentions_record RecordBuilder
   */
  public static Builder newBuilder(mentions_record other) {
    return new Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<mentions_record>
     ...
     * @param other The existing instance to copy.
     */
    private Builder(mentions_record other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.start)) {
        this.start = data().deepCopy(fields()[0].schema(), other.start);
        fieldSetFlags()[0] = true;
    ...
    public mentions_record build() {
      try {
        ...
        record.username = fieldSetFlags()[2] ? this.username : (CharSequence) defaultValue(fields()[2]);
        record.id = fieldSetFlags()[3] ? this.id : (CharSequence) defaultValue(fields()[3]);
        return record;
      } catch (Exception e) {
