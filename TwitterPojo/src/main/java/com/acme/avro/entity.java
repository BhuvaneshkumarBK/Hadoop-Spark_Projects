...
public class entity extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public entity(java.lang.CharSequence id, java.lang.CharSequence name) {
    this.id = id;
    this.name = name;
  }
   ...
   */
  public static com.acme.avro.entity.Builder newBuilder() {
    return new com.acme.avro.entity.Builder();
  }
   ...
   * @return A new entity RecordBuilder
   */
  public static com.acme.avro.entity.Builder newBuilder(com.acme.avro.entity.Builder other) {
    return new com.acme.avro.entity.Builder(other);
  }
   ...
   * @return A new entity RecordBuilder
   */
  public static com.acme.avro.entity.Builder newBuilder(com.acme.avro.entity other) {
    return new com.acme.avro.entity.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<entity>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.acme.avro.entity.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.acme.avro.entity other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.acme.avro.entity.Builder setId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.acme.avro.entity.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.acme.avro.entity.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.acme.avro.entity.Builder clearName() {
      name = null;
