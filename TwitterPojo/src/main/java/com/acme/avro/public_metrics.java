...
public class public_metrics extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public public_metrics(java.lang.Integer retweet_count, java.lang.Integer reply_count, java.lang.Integer like_count, java.lang.Integer quote_count) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: retweet_count = (java.lang.Integer)value$; break;
    case 1: reply_count = (java.lang.Integer)value$; break;
    case 2: like_count = (java.lang.Integer)value$; break;
    case 3: quote_count = (java.lang.Integer)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   * @param value the value to set.
   */
  public void setLikeCount(java.lang.Integer value) {
   ...
   */
  public java.lang.Integer getQuoteCount() {
    return quote_count;
  }
   ...
   * @param value the value to set.
   */
  public void setQuoteCount(java.lang.Integer value) {
   ...
   */
  public static com.acme.avro.public_metrics.Builder newBuilder() {
    return new com.acme.avro.public_metrics.Builder();
  }
   ...
   * @return A new public_metrics RecordBuilder
   */
  public static com.acme.avro.public_metrics.Builder newBuilder(com.acme.avro.public_metrics.Builder other) {
    return new com.acme.avro.public_metrics.Builder(other);
  }
   ...
   * @return A new public_metrics RecordBuilder
   */
  public static com.acme.avro.public_metrics.Builder newBuilder(com.acme.avro.public_metrics other) {
    return new com.acme.avro.public_metrics.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<public_metrics>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.acme.avro.public_metrics.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.acme.avro.public_metrics other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.retweet_count)) {
        this.retweet_count = data().deepCopy(fields()[0].schema(), other.retweet_count);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.acme.avro.public_metrics.Builder setRetweetCount(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.acme.avro.public_metrics.Builder clearRetweetCount() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.acme.avro.public_metrics.Builder setReplyCount(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.acme.avro.public_metrics.Builder clearReplyCount() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.acme.avro.public_metrics.Builder setLikeCount(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.acme.avro.public_metrics.Builder clearLikeCount() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.acme.avro.public_metrics.Builder setQuoteCount(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.acme.avro.public_metrics.Builder clearQuoteCount() {
    ...
    public public_metrics build() {
      try {
        ...
        record.retweet_count = fieldSetFlags()[0] ? this.retweet_count : (java.lang.Integer) defaultValue(fields()[0]);
        record.reply_count = fieldSetFlags()[1] ? this.reply_count : (java.lang.Integer) defaultValue(fields()[1]);
        record.like_count = fieldSetFlags()[2] ? this.like_count : (java.lang.Integer) defaultValue(fields()[2]);
        record.quote_count = fieldSetFlags()[3] ? this.quote_count : (java.lang.Integer) defaultValue(fields()[3]);
        return record;
      } catch (Exception e) {
