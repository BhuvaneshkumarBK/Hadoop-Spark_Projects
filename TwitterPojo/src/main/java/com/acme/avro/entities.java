...
public class entities extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public java.util.List<com.acme.avro.hashtags_record> hashtags;
  @Deprecated public java.util.List<com.acme.avro.mentions_record> mentions;
   ...
   */
  public entities(java.util.List<com.acme.avro.hashtags_record> hashtags, java.util.List<com.acme.avro.mentions_record> mentions) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: hashtags = (java.util.List<com.acme.avro.hashtags_record>)value$; break;
    case 1: mentions = (java.util.List<com.acme.avro.mentions_record>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public java.util.List<com.acme.avro.hashtags_record> getHashtags() {
    return hashtags;
  }
   ...
   */
  public void setHashtags(java.util.List<com.acme.avro.hashtags_record> value) {
    this.hashtags = value;
  }
   ...
   */
  public java.util.List<com.acme.avro.mentions_record> getMentions() {
    return mentions;
  }
   ...
   * @param value the value to set.
   */
  public void setMentions(java.util.List<com.acme.avro.mentions_record> value) {
    this.mentions = value;
  }
   ...
   */
  public static com.acme.avro.entities.Builder newBuilder() {
    return new com.acme.avro.entities.Builder();
  }
   ...
   * @return A new entities RecordBuilder
   */
  public static com.acme.avro.entities.Builder newBuilder(com.acme.avro.entities.Builder other) {
    return new com.acme.avro.entities.Builder(other);
  }
   ...
   * @return A new entities RecordBuilder
   */
  public static com.acme.avro.entities.Builder newBuilder(com.acme.avro.entities other) {
    return new com.acme.avro.entities.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<entities>
    ...
    private java.util.List<com.acme.avro.hashtags_record> hashtags;
    private java.util.List<com.acme.avro.mentions_record> mentions;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.acme.avro.entities.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.acme.avro.entities other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.hashtags)) {
        this.hashtags = data().deepCopy(fields()[0].schema(), other.hashtags);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.acme.avro.entities.Builder setHashtags(java.util.List<com.acme.avro.hashtags_record> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.acme.avro.entities.Builder clearHashtags() {
      hashtags = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.acme.avro.entities.Builder setMentions(java.util.List<com.acme.avro.mentions_record> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.acme.avro.entities.Builder clearMentions() {
      mentions = null;
    ...
    public entities build() {
      try {
        ...
        record.hashtags = fieldSetFlags()[0] ? this.hashtags : (java.util.List<com.acme.avro.hashtags_record>) defaultValue(fields()[0]);
        record.mentions = fieldSetFlags()[1] ? this.mentions : (java.util.List<com.acme.avro.mentions_record>) defaultValue(fields()[1]);
        return record;
      } catch (Exception e) {
