...
public class Twittr extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static com.acme.avro.Twittr.Builder newBuilder() {
    return new com.acme.avro.Twittr.Builder();
  }
   ...
   * @return A new Twittr RecordBuilder
   */
  public static com.acme.avro.Twittr.Builder newBuilder(com.acme.avro.Twittr.Builder other) {
    return new com.acme.avro.Twittr.Builder(other);
  }
   ...
   * @return A new Twittr RecordBuilder
   */
  public static com.acme.avro.Twittr.Builder newBuilder(com.acme.avro.Twittr other) {
    return new com.acme.avro.Twittr.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Twittr>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.acme.avro.Twittr.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.acme.avro.Twittr other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.data)) {
        this.data = data().deepCopy(fields()[0].schema(), other.data);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.acme.avro.Twittr.Builder setData(com.acme.avro.data value) {
     ...
     * @return This builder.
     */
    public com.acme.avro.Twittr.Builder setDataBuilder(com.acme.avro.data.Builder value) {
      clearData();
      dataBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public com.acme.avro.Twittr.Builder clearData() {
      data = null;
      dataBuilder = null;
