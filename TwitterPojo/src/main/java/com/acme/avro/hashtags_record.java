...
public class hashtags_record extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public hashtags_record(java.lang.Integer start, java.lang.Integer end, java.lang.CharSequence tag) {
    this.start = start;
    this.end = end;
    this.tag = tag;
  }
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: tag = (java.lang.CharSequence)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public static com.acme.avro.hashtags_record.Builder newBuilder() {
    return new com.acme.avro.hashtags_record.Builder();
  }
   ...
   * @return A new hashtags_record RecordBuilder
   */
  public static com.acme.avro.hashtags_record.Builder newBuilder(com.acme.avro.hashtags_record.Builder other) {
    return new com.acme.avro.hashtags_record.Builder(other);
  }
   ...
   * @return A new hashtags_record RecordBuilder
   */
  public static com.acme.avro.hashtags_record.Builder newBuilder(com.acme.avro.hashtags_record other) {
    return new com.acme.avro.hashtags_record.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<hashtags_record>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.acme.avro.hashtags_record.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.acme.avro.hashtags_record other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.start)) {
        this.start = data().deepCopy(fields()[0].schema(), other.start);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.acme.avro.hashtags_record.Builder setStart(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.acme.avro.hashtags_record.Builder clearStart() {
      start = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.acme.avro.hashtags_record.Builder setEnd(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.acme.avro.hashtags_record.Builder clearEnd() {
      end = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.acme.avro.hashtags_record.Builder setTag(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.acme.avro.hashtags_record.Builder clearTag() {
      tag = null;
    ...
    public hashtags_record build() {
      try {
        ...
        record.tag = fieldSetFlags()[2] ? this.tag : (java.lang.CharSequence) defaultValue(fields()[2]);
        return record;
      } catch (Exception e) {
